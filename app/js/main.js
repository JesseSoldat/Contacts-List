...
var APP_ID = 'm5UX1mLV60kfzS5IO5tfKnXFWA8Yjj1X7FKl8tHM';
var API_KEY = 'MXgBISqr4yfUkD1mia7b9fR7JXzoivs4KStY3zfZ';
...
},{"./contact_model":2,"backbone":9}],4:[function(require,module,exports){
'use strict';
...
var appElement = (0, _jquery2['default'])('.app'); //get the div with a class of .app

var router = new _router2['default'](appElement); //created an instance with the Router constructor and use the appElement as its parameter 
...
var Router = _backbone2['default'].Router.extend({
  ...
  initialize: function initialize(appElement) {
    ...
    this.$el.on('click', '.contact-list-item', function (event) {
      //click on any li (delegate) and the event will bubble up to the event listener the (div in index.html)
      var $li = (0, _jquery2['default'])(event.currentTarget); // the list item that we clicked on
  ...
  showSpinner: function showSpinner() {
    // shows a spinner while waiting for the dated to load
...
},{"./contacts_collection":3,"./views/contact":6,"./views/contacts":7,"backbone":9,"jquery":10}],6:[function(require,module,exports){
"use strict";
